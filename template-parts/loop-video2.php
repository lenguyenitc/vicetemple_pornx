<article id="post-<?php the_ID(); ?>" <?php if(xbox_get_field_value( 'my-theme-options', 'mob-number_videos_per_row' ) == '1') { post_class('thumb-block post full-width'); }else{ post_class('thumb-block post'); } ?>>
	<?php
