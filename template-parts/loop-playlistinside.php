<article id="post-<?php the_ID(); ?>" <?php if(xbox_get_field_value( 'my-theme-options', 'mob-number_videos_per_row' ) == '1') { post_class('thumb-block full-width'); }else{ post_class('thumb-block'); } ?>>
	<?php global $set_query_playlist_author_id; ?>
    <?php
    ...
    <a href="<?php echo $permalink; ?>" title="<?php the_title(); ?>" data-toggle="<?php echo $data_toggle;?>" data-target="<?php echo $data_target;?>">
		...
		<?php if( $trailer_url != '' && !wp_is_mobile() && $trailer_url !== false && $trailer_url !== 'false' && $trailer_url !== 'http://false' && $trailer_url !== 'https://false') : ?>
            ...
            <div class="post-thumbnail video-with-trailer">
	            ...
	            <?php if(is_user_logged_in() && get_current_user_id() == $set_query_playlist_author_id) :?>
                    <span class="delete_video_from_playlist" data-post-id="<?=$post->ID?>" style="cursor: pointer">
                        <svg width="25" height="22" viewBox="0 0 25 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <rect width="25" height="22" rx="4" fill="#1E2739" fill-opacity="0.8"></rect>
                                                    <path fill-rule="evenodd" clip-rule="evenodd" d="M18.1129 5.06928C17.82 4.77639 17.3451 4.77639 17.0522 5.06928L12.4992 9.62232L7.94623 5.06935C7.65334 4.77646 7.17847 4.77646 6.88557 5.06935C6.59268 5.36224 6.59268 5.83712 6.88557 6.13001L11.4385 10.683L6.25092 15.8706C5.95803 16.1635 5.95803 16.6384 6.25092 16.9313C6.54381 17.2242 7.01869 17.2242 7.31158 16.9313L12.4992 11.7436L17.6869 16.9313C17.9798 17.2242 18.4547 17.2242 18.7476 16.9313C19.0405 16.6384 19.0405 16.1636 18.7476 15.8707L13.5599 10.683L18.1129 6.12994C18.4058 5.83705 18.4058 5.36217 18.1129 5.06928Z" fill="white"></path>
                                                    </svg>
                    </span>
	            <?php endif;?>
            </div>
